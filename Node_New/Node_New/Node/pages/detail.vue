    ...
    async addCart(number) {
      ...
      if (
        ...
        if (isTrue === false) {
          ...
          if (check <= this.product.inStocks) {
            ...
            this.$swal.fire({
              ...
              icon: 'error',
              title:
                'Tổng số lượng  sản phẩm trong giỏ sau khi đặt là : ' + check  + '.Bạn đặt vượt quá kho hàng .Vui lòng nhập lai!',
              showConfirmButton: false,
              timer: 2000,
            })
          }
        ...
        this.$swal.fire({
          ...
          icon: 'error',
          title:
            'Số lượng  sản phẩm  bị lỗi.Vui lòng nhập lai!' ,
          showConfirmButton: false,
          timer: 1500,
        })
      }
